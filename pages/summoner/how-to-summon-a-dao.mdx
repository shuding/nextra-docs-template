...
Next, you'll need to provide names for your DAO's voting and non-voting tokens. Symbol is the abbreviated name used in wallets and apps and cannot be longer than 5 characters. Keep in mind these tokens are deployed on-chain and cannot be changed later.
