...
Percentage of DAO members required to vote for proposal approval.
...
Fee of native tokens required to submit proposals, helping to guard against spam.
...
The act of a member burning a certain amount of voting or non-voting tokens to receive a proportional amount of tokens from the DAO's treasury.

## Rage Kick

A forced version of ragequit, instigated by other members, which burns all of a member's voting and non-voting tokens, converting them into a proportionate amount of tokens from the DAO's treasury.
